/*
9.22~9.30 女神狂欢 大牌盛典  [gua_opencard25.js]
新增开卡脚本
一次性脚本
...
关注10京豆 (有可能是空气💨
加购5京豆 (有可能是空气💨 默认不加购 如需加购请设置环境变量[guaopencard_addSku25]为"true"
...
guaopencard25="true"
————————————————
入口：[9.22~9.30 女神狂欢 大牌盛典  (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7768835?activityId=02d54511202b4d1781088b66b9e07b9c&shareUuid=c0bcf5c57dcc4446aab0f0fe111f6497)]
============Quantumultx===============
[task_local]
#9.22~9.30 女神狂欢 大牌盛典 
...
===============Surge=================
9.22~9.30 女神狂欢 大牌盛典  = type=cron,cronexp="30 9,21 18-25 8 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard12.js

============小火箭=========
9.22~9.30 女神狂欢 大牌盛典  = type=cron,script-path=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard12.js, cronexpr="30 9,21 18-25 8 *", timeout=3600, enable=true
*/
...
guaopencard_addSku = $.isNode() ? (process.env.guaopencard_addSku25 ? process.env.guaopencard_addSku25 : `${guaopencard_addSku}`) : ($.getdata('guaopencard_addSku25') ? $.getdata('guaopencard_addSku25') : `${guaopencard_addSku}`);
message = ""
!(async () => {
  if (!cookiesArr[0]) {
  ...
  if ($.isNode()) {
    if (!process.env.guaopencard25 || process.env.guaopencard25 == "false") {
      console.log('如需执行脚本请设置环境变量[guaopencard25]为"true"')
      return
    }
  }
  $.shareUuid = '921c0d198c3c4cee9982fae565005cfc'
...
async function run(){
  try{
    ...
    $.log("加购: " + $.addSku)
    if(!$.addSku && guaopencard_addSku+"" != "true") console.log('如需加购请设置环境变量[guaopencard_addSku25]为"true"');
