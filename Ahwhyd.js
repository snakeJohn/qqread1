...
[task_local]
#好物好生活
40 0,2 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_xddb.js, tag=心动电波, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "40 0,2 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_xddb.js,tag=好物好生活

===============Surge=================
好物好生活 = type=cron,cronexp="40 0,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_xddb.js

============小火箭=========
好物好生活 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_xddb.js, cronexpr="40 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('好物好生活');
...
let appIdArr = ['1FV1ZwKY'];
let appNameArr = ['好物好生活'];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
